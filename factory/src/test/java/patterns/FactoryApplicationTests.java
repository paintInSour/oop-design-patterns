...
class FactoryApplicationTests {
    ...
    void assertCreatedHtmlParser() {
        ...
        FileParserFactory<Parser> factory = fileParserFactoryProviderService.getFactory(FileSource.WEB);
    ...
    void assertCreatedXMLParser() {
        ...
        FileParserFactoryProviderService fileParserFactoryProviderService = new FileParserFactoryProviderService();
        FileParserFactory<Parser> factory = fileParserFactoryProviderService.getFactory(FileSource.FILESYSTEM);
